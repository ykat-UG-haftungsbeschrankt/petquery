...
class PetQueryModules{
	constructor(petQueryConfig){
		...
		let dirent;
		const dir = fs.opendirSync(__dirname+'/../../modules');
		while((dirent = dir.readSync()) !== null){
			if(fs.existsSync(__dirname+'/../../modules/'+dirent.name+'/index.js')
			&& this._cfg.module[dirent.name]?.enabled !== false){
				console.log('Loading module '+dirent.name);
				let module = require(__dirname+'/../../modules/'+dirent.name+'/index.js');
